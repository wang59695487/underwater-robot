...
extern int markFlag;
extern char markResult[4];
extern int detectFlag;
extern char detectResult2[8];
...
//		cout<<"!!!!!!!!!!!!detectFlag is :"<<detectFlag<<endl;
		...
		{   sendFrameId = 0X23;
		    frameLen = 0X0F;
			tempDistance = (char*)(&resultDistance);
			tempAngle = (char*)(&resultAngle);
			sendFrame[0] = frameHead;
			sendFrame[1] = frameLen;
			sendFrame[2] = sendFrameCnt;
			sendFrame[3] = sendFrameId;
			memcpy(sendFrame+4,tempAngle,4);
	  ...
	  if(1 == markFlag)
		{
			...
			sendFrame[2] = sendFrameCnt;
			sendFrame[3] = sendFrameId;
			memcpy(sendFrame+4,markResult,4);
...
//				usleep(1000);
		...
		{   sendFrameId = 0X25;
			...
			sendFrame[2] = sendFrameCnt;
			sendFrame[3] = sendFrameId;
			memcpy(sendFrame+4,detectResult2,8);
			checkValue = crc_check(sendFrame,12);
			sendFrame[12] = checkValue>>8;
			sendFrame[13] = checkValue&0X00FF;
			sendFrame[14] = frameTail;
